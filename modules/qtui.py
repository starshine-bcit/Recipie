...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_11.addWidget(self.radioButtonInclusive)
        ...
        self.verticalLayout_11.addWidget(self.pushButtonRemoveSelected)
        ...
        self.verticalLayout_10.addWidget(self.radioButtonExclusive)
        ...
        self.verticalLayout_10.addWidget(self.pushButtonResetSearch)
        ...
        self.frameDietCheckboxes = QtWidgets.QFrame(self.tabFilter)
        self.frameDietCheckboxes.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.frameDietCheckboxes.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frameDietCheckboxes.setObjectName("frameDietCheckboxes")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.frameDietCheckboxes)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.LabelFilterDesciption = QtWidgets.QLabel(self.frameDietCheckboxes)
        self.LabelFilterDesciption.setWordWrap(True)
        self.LabelFilterDesciption.setObjectName("LabelFilterDesciption")
        self.verticalLayout_9.addWidget(self.LabelFilterDesciption)
        self.checkBoxVegetarian = QtWidgets.QCheckBox(self.frameDietCheckboxes)
        self.checkBoxVegetarian.setObjectName("checkBoxVegetarian")
        self.verticalLayout_9.addWidget(self.checkBoxVegetarian)
        self.checkBoxVegan = QtWidgets.QCheckBox(self.frameDietCheckboxes)
        self.checkBoxVegan.setObjectName("checkBoxVegan")
        self.verticalLayout_9.addWidget(self.checkBoxVegan)
        self.checkBoxNut = QtWidgets.QCheckBox(self.frameDietCheckboxes)
        self.checkBoxNut.setObjectName("checkBoxNut")
        self.verticalLayout_9.addWidget(self.checkBoxNut)
        self.checkBoxLactose = QtWidgets.QCheckBox(self.frameDietCheckboxes)
        self.checkBoxLactose.setObjectName("checkBoxLactose")
        self.verticalLayout_9.addWidget(self.checkBoxLactose)
        self.checkBoxGluten = QtWidgets.QCheckBox(self.frameDietCheckboxes)
        self.checkBoxGluten.setObjectName("checkBoxGluten")
        self.verticalLayout_9.addWidget(self.checkBoxGluten)
        self.verticalLayout_7.addWidget(self.frameDietCheckboxes)
        self.frameDisclaimer = QtWidgets.QFrame(self.tabFilter)
        self.frameDisclaimer.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.frameDisclaimer.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frameDisclaimer.setObjectName("frameDisclaimer")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.frameDisclaimer)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.labelDisclaimer = QtWidgets.QLabel(self.frameDisclaimer)
        self.labelDisclaimer.setWordWrap(True)
        self.labelDisclaimer.setObjectName("labelDisclaimer")
        self.verticalLayout_2.addWidget(self.labelDisclaimer)
        self.verticalLayout_7.addWidget(self.frameDisclaimer)
        spacerItem5 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout_7.addItem(spacerItem5)
        self.horizontalLayoutFilterButtons = QtWidgets.QHBoxLayout()
        self.horizontalLayoutFilterButtons.setObjectName("horizontalLayoutFilterButtons")
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayoutFilterButtons.addItem(spacerItem6)
        self.pushButtonSendFilterSearch = QtWidgets.QPushButton(self.tabFilter)
        self.pushButtonSendFilterSearch.setObjectName("pushButtonSendFilterSearch")
        self.horizontalLayoutFilterButtons.addWidget(self.pushButtonSendFilterSearch)
        spacerItem7 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayoutFilterButtons.addItem(spacerItem7)
        self.pushButtonResetFilters = QtWidgets.QPushButton(self.tabFilter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayoutFilterButtons.addWidget(self.pushButtonResetFilters)
        spacerItem8 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayoutFilterButtons.addItem(spacerItem8)
        self.horizontalLayoutFilterButtons.setStretch(0, 1)
        self.horizontalLayoutFilterButtons.setStretch(2, 1)
        self.horizontalLayoutFilterButtons.setStretch(4, 1)
        self.verticalLayout_7.addLayout(self.horizontalLayoutFilterButtons)
        ...
        self.horizontalLayoutBottomRecipeDisplay.addItem(spacerItem9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditIngredientEntry.setToolTip(_translate("MainWindow", "Enter ingredients you want to search for"))
        self.lineEditIngredientEntry.setPlaceholderText(_translate("MainWindow", "Enter Ingredients Here"))
        self.commandLinkButtonEnterIngredient.setToolTip(_translate("MainWindow", "Add your ingredient to the list below and search"))
        self.listWidgetSearchInput.setToolTip(_translate("MainWindow", "All the ingredients you\'ve entered so far"))
        self.radioButtonInclusive.setToolTip(_translate("MainWindow", "Will return all recipes that use ingredients you specified, as well as others"))
        self.radioButtonInclusive.setText(_translate("MainWindow", "Partial"))
        self.pushButtonRemoveSelected.setToolTip(_translate("MainWindow", "Remove selected search terms from above"))
        self.pushButtonRemoveSelected.setText(_translate("MainWindow", "Rem. Selected"))
        self.radioButtonExclusive.setToolTip(_translate("MainWindow", "Will return only recipes that match the ingredients you\'ve specified, nothing extra needed!"))
        self.radioButtonExclusive.setText(_translate("MainWindow", "Exact"))
        self.pushButtonResetSearch.setToolTip(_translate("MainWindow", "Clear all search results and terms"))
        ...
        self.frameDietCheckboxes.setToolTip(_translate("MainWindow", "Select which dietary restrictions you have"))
        self.LabelFilterDesciption.setText(_translate("MainWindow", "Select your dietary restrictions:"))
        self.checkBoxVegetarian.setText(_translate("MainWindow", "Vegetarian"))
        self.checkBoxVegan.setText(_translate("MainWindow", "Vegan"))
        self.checkBoxNut.setText(_translate("MainWindow", "Nut Free"))
        self.checkBoxLactose.setText(_translate("MainWindow", "Lactose Free"))
        self.checkBoxGluten.setText(_translate("MainWindow", "Gluten Free"))
        self.labelDisclaimer.setToolTip(_translate("MainWindow", "Standard disclaimer"))
        self.labelDisclaimer.setText(_translate("MainWindow", "DISCLAIMER: We cannot guarantee that displayed recipes are actually safe for your particular diet. Please exercise your best judgement ."))
        self.pushButtonSendFilterSearch.setToolTip(_translate("MainWindow", "Search with these categories and whichever ingredients you entered"))
        self.pushButtonSendFilterSearch.setText(_translate("MainWindow", "Search!"))
        self.pushButtonResetFilters.setToolTip(_translate("MainWindow", "Uncheck all filters"))
        ...
        self.labelRecipeName.setToolTip(_translate("MainWindow", "Name of recipe"))
        ...
        self.textBrowserRecipeIngredients.setToolTip(_translate("MainWindow", "Ingredients of recipe"))
        self.labelRecipeDirections.setText(_translate("MainWindow", "Directions:"))
        self.textBrowserRecipeDirections.setToolTip(_translate("MainWindow", "How to make this recipe"))
        self.pushButtonDisplayRecipeNewWindow.setToolTip(_translate("MainWindow", "Open a nicely formatted version in a new window"))
        ...
        self.pushButtonAddFavourite.setToolTip(_translate("MainWindow", "Add to favourites list"))
        self.pushButtonAddFavourite.setText(_translate("MainWindow", "Add Favourite"))
        self.pushButtonRecipeClear.setToolTip(_translate("MainWindow", "Clear currently displayed recipe"))
        ...
        self.listWidgetSearchResults.setToolTip(_translate("MainWindow", "All the delicious recipes we found for you"))
        self.tabWidgetRecipe.setTabText(self.tabWidgetRecipe.indexOf(self.tabSearchResults), _translate("MainWindow", "Search Results"))
        self.pushButtonRemoveAllFavourites.setToolTip(_translate("MainWindow", "Remove all favourites"))
        self.pushButtonRemoveAllFavourites.setText(_translate("MainWindow", "Remove All"))
        self.pushButtonRemoveSelectedFavourites.setToolTip(_translate("MainWindow", "Remove only selected favourites"))
